# В портфолио собраны мои проекты, выполненные во время обучения на расширенном курсе "Инженер по тестированию плюс" в Яндекс.Практикуме. Так же в 9 пункте представлен проект от реального заказчика который я тестировал.
